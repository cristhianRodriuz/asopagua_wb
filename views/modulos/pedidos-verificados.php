<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h3 class="h3 mb-2 text-gray-800">Pedidos Verificados</h3>
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped dt-responsive text-center" style="font-size: 12px;" id="dataTablePedidos" filterTable="Verificado" width="100%" cellspacing="0">
