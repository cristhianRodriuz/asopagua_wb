            ...
            <form class="col infoUser" id="clienteForm">
                    ...
                    <div action="">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="nombreClientePedido" id="nombreClientePedido" class="form-control" disabled>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="">Apellido</label>
                                <input type="text" name="apellidoClientePedido" id="apellidoClientePedido" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="">Teléfono</label>
                                <input type="number" name="telefonoClientePedido" id="telefonoClientePedido" class="form-control" disabled>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="">Celular</label>
                                <input type="number" name="celularClientePedido" id="celularClientePedido" class="form-control" disabled>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" id="checkInformacionEnvio" disabled>
                        <label class="form-check-label" for="checkInformacionEnvio">Editar Información de Envío</label>
                    </div>
                    <div class="form-group">
                        <label for="">Provincia</label>
                        <input type="text" name="provinciaClientePedido" id="provinciaClientePedido" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                        <label for="">Cantón</label>
                        <input type="text" name="cantonClientePedido" id="cantonClientePedido" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                        <label for="">Parroquia</label>
                        <input type="text" name="parroquiaClientePedido" id="parroquiaClientePedido" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                        <label for="">Dirección</label>
                        <textarea class="form-control" name="direccionClientePedido" id="direccionClientePedido" disabled></textarea>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        function disabledInputs() {
            $("#dniCliente").attr("disabled", true);
            $("#emailCliente").attr("disabled", true);
            $("#checkInformacionEnvio").attr("disabled", false);
        }
    });
</script>
